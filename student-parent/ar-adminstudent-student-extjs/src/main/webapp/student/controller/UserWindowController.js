 ...
 * @author chenyanxu
 */
Ext.define('kalix.adminstudent.student.controller.UserWindowController', {
    extend: 'kalix.controller.BaseWindowController',
    alias: 'controller.studentUserWindowController',
    ...
    blur: function (target, event, eOpts) {
        ...
        var rest_url = CONFIG.restRoot + '/camel/rest/students/loginname/' + lv;
        Ext.Ajax.request({
            url: rest_url,
