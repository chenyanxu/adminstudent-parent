...
import com.kalix.ar.adminstudent.course.api.biz.ICourseSelectBeanService;
import com.kalix.ar.adminstudent.course.api.dao.ICourseSelectBeanDao;
import com.kalix.ar.adminstudent.course.dto.model.CourseSelectDTO;
 ...
 * @修改备注：
 */
public class CourseSelectBeanServiceImpl extends ShiroGenericBizServiceImpl<ICourseSelectBeanDao, CourseSelectBean> implements ICourseSelectBeanService {
    ...
    private static String BASE_SQL = " select t1.id,t1.courseid,t2.name coursename,t1.studentid,t3.name studentname," +
            ...
            " from adminstudent_course_select t1,adminteacher_course t2,sys_user_student t3," +
    ...
    public CourseSelectBeanServiceImpl() {
        super.init(CourseSelectBean.class.getName());
    }

    @Override
    public JsonData getAllCourseSelect(Integer page, Integer limit, String jsonStr, String sort) {
        ...
        return this.dao.findByNativeSql(sql, page, limit, CourseSelectDTO.class);
    ...
    @Override
    public JsonData getCourseSelectDTOByStudentId(long studentId, Integer page, Integer limit, String jsonStr, String sort) {
        ...
        /*sql = sql + CommonMethod.createPagedQueryCondition(page, limit, jsonStr, sort);*/
        sql = sql + CommonMethod.createWhereCondition(jsonStr, sort);
        /*List list = this.dao.findByNativeSql(sql, CourseSelectDTO.class, studentId);
        jsonData.setData(list);*/
        return this.dao.findByNativeSql(sql, page, limit, CourseSelectDTO.class, studentId);
    ...
    @Override
    public JsonData getCourseSelectDTOByCourseId(long courseId, Integer page, Integer limit, String jsonStr, String sort) {
        ...
        /*sql = sql + CommonMethod.createPagedQueryCondition(page, limit, jsonStr, sort);*/
        sql = sql + CommonMethod.createWhereCondition(jsonStr, sort);
        /*List list = this.dao.findByNativeSql(sql, CourseSelectDTO.class, courseId);
        jsonData.setData(list);*/
        return this.dao.findByNativeSql(sql, page, limit, CourseSelectDTO.class, courseId);
    ...
    private List<CourseSelectDTO> getAllCourseSelect(String jsonStr, String sort) {

        String whereCondition = CommonMethod.createWhereCondition(jsonStr, sort);
        String sql = "select * from (" + BASE_SQL + ") t ";
        if (!whereCondition.equals("")) {
            sql = sql + " where " + whereCondition;
        }
        return this.dao.findByNativeSql(sql, CourseSelectDTO.class);
    }
    ...
    /*private JsonData listCoursesToJson(List list) {
        ...
        for (Object record : list) {
            if (record != null) {
                if (values.isEmpty()) {
                    values = String.valueOf(((CourseSelectBean)record).getCourseid());
                }
                else {
                    values = values + "," + String.valueOf(((CourseSelectBean)record).getCourseid());
                }
            }
        }
